---
layout: default
title: "How AI Can Help and Change Physics-Based Simulations Like FEA"
description: "How AI can improve rubber and tire simulation workflows while keeping physics, assumptions, verification, and validation under control."
content_type: essay
...
topics:
  ...
  - Tire design
  - Industrial AI
permalink: /posts/ai-physics-based-tire-simulations.html
nav: essays
...
- It has not been smooth to generate a mesh for simulations
- process documented using pictures, excel, powerpoint and word documents
- FE software system keep updating, but those documents are not necessary updated, not matter we are using internal solver or external solver supplier, there are always internal process
